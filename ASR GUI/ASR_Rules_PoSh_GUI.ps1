...
<Window x:Class="ASR_GUI_Radio.MainWindow"
        ...
        mc:Ignorable="d"
        Title="ASR Rules PoSh GUI - Version 1.2 - 14rd Aug 2024" Width="900" Height="680" MaxHeight="680" MaxWidth="900" MinHeight="680" MinWidth="900">
    <StackPanel>
        ...
        <Grid>
            ...
            <Label Content="Block rebooting machine in Safe Mode (preview)" Grid.Column="0" />
            <RadioButton x:Name="RebootSafeD" Content="Disabled" VerticalAlignment="Center"  Grid.Column="1" HorizontalAlignment="Left" Grid.IsSharedSizeScope="True" Panel.ZIndex="2" />
            <RadioButton x:Name="RebootSafeA" Content="Audit" VerticalAlignment="Center"  Grid.Column="2" HorizontalAlignment="Left" Grid.IsSharedSizeScope="True" Panel.ZIndex="2" />
            <RadioButton x:Name="RebootSafeB" Content="Enabled" VerticalAlignment="Center" Grid.Column="3" HorizontalAlignment="Left" Grid.IsSharedSizeScope="True" Panel.ZIndex="2" />
            <RadioButton x:Name="RebootSafeW" Content="Warn" VerticalAlignment="Center" Grid.Column="4" HorizontalAlignment="Left" Grid.IsSharedSizeScope="True" Panel.ZIndex="2" />
        </Grid>
        <Grid>
            <Grid.ColumnDefinitions>
                <ColumnDefinition Width="5*"/>
            ...
            <Label Content="Block use of copied or impersonated system tools (preview)" Grid.Column="0" />
            <RadioButton x:Name="ImpersonSysToolsD" Content="Disabled" VerticalAlignment="Center"  Grid.Column="1" HorizontalAlignment="Left" Grid.IsSharedSizeScope="True" Panel.ZIndex="2" />
            <RadioButton x:Name="ImpersonSysToolsA" Content="Audit" VerticalAlignment="Center"  Grid.Column="2" HorizontalAlignment="Left" Grid.IsSharedSizeScope="True" Panel.ZIndex="2" />
            <RadioButton x:Name="ImpersonSysToolsB" Content="Enabled" VerticalAlignment="Center" Grid.Column="3" HorizontalAlignment="Left" Grid.IsSharedSizeScope="True" Panel.ZIndex="2" />
            <RadioButton x:Name="ImpersonSysToolsW" Content="Warn" VerticalAlignment="Center" Grid.Column="4" HorizontalAlignment="Left" Grid.IsSharedSizeScope="True" Panel.ZIndex="2" />
        </Grid>
...
"@ -replace 'mc:Ignorable="d"','' -replace "x:N",'N' -replace '^<Win.*', '<Window' #-replace is necessary, if XAML was copied from Visual Studio.
#Read XAML
[void][System.Reflection.Assembly]::LoadWithPartialName('presentationframework')
try{
   $Form=[Windows.Markup.XamlReader]::Load( (New-Object System.Xml.XmlNodeReader $XAML) )
} catch {
   Write-Host "Windows.Markup.XamlReader could not be loaded. Possible Reason: Syntax or missing .net"
}
...
function ASRReset {
    ...
    $RadioArray = "OAppChildProc", "ObfusScript", "MacroAPI", "OfficeCreateExe", "OfficeCodeInj", "ScriptDwnlExe", "MailExe", "FileCriteria", "Ransomware", "lsass", "prcCreate", "USB", "OCommChildProc", "PDFChildProc", "WMIPers", "VulnDrivers", "RebootSafe", "ImpersonSysTools"
    ...
    ForEach ($j in $RulesIds){
        ...
        ElseIf ($RulesIdsArray[$counter] -eq "33ddedf1-c6e0-47cb-833e-de6133960387"){$ASR = "RebootSafe"}
        ElseIf ($RulesIdsArray[$counter] -eq "c0033c00-d16d-4114-a5a0-dc9b3a7d2ceb"){$ASR = "ImpersonSysTools"}
...
$btnReport.Add_Click({
    ...
    ForEach ($j in $RulesIds){
        ...
        ElseIf ($RulesIdsArray[$counter] -eq "33ddedf1-c6e0-47cb-833e-de6133960387"){$RuleName = "Block rebooting machine in Safe Mode (preview)"}
        ElseIf ($RulesIdsArray[$counter] -eq "c0033c00-d16d-4114-a5a0-dc9b3a7d2ceb"){$RuleName = "Block use of copied or impersonated system tools (preview)"}
